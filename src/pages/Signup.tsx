      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Join LLMHUB and start your AI journey
          </p>
        </div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-xl
                         ...
                         ${errors.fullName 
                           ...
                           : 'border-gray-200 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-200 dark:focus:border-blue-400 dark:focus:ring-blue-900/50'
                         }`}
