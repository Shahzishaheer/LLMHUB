...
const Login = (): JSX.Element => {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12 bg-obsidian overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cobalt/20 blur-[150px] rounded-full pointer-events-none animate-pulse-slow" />
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate mt-1 opacity-60">Secure Access Grid</p>
          </div>
        </div>
